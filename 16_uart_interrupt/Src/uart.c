...
void uart2_rxtx_inint(void) {
	...
	// configure transfer direction from UART_CR1 RefManual
	USART2->CR1 = (CR1_TE | CR1_RE); // note no OR operator, sets everyting else to 1, doesn't keep original registers val.
...
char uart2_read(void) {
	// make sure recieve data reg is empty
